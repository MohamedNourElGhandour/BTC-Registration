...
namespace Eng1
{
    public partial class frmAllEvaluationReport : Form
    {
        public frmAllEvaluationReport()
        {
            InitializeComponent();
        }

        private void frmAllEvaluationReport_Load(object sender, EventArgs e)
        {
            //ReportDocument r = new ReportDocument();
            //r.Load(Application.StartupPath + "\\CrystalReport3.rpt");
            //crystalReportViewer1.ReportSource = r;
            //crystalReportViewer1.Refresh();

            FileInfo o = new FileInfo(Application.StartupPath + "\\CrystalReport3.rpt");
